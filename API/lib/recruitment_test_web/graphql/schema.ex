defmodule RecruitmentTestWeb.Schema do
  ...
  query do
    ...
    field :collaborators, :paginated_collaborators do
      arg(:pagination, :pagination_input)
      arg(:filters, :collaborator_filters)
    ...
    field :enterprises, :paginated_enterprises do
      arg(:pagination, :pagination_input)
      arg(:filters, :enterprise_filters)
    ...
    field :contracts, :paginated_contracts do
      arg(:pagination, :pagination_input)
      arg(:filters, :contract_filters)
    ...
    @desc "List all tasks"
    field :tasks, :paginated_tasks do
      arg(:pagination, :pagination_input)
      arg(:filters, :task_filters)
    ...
    field :reports, :paginated_reports do
      arg(:pagination, :pagination_input)
      arg(:filters, :report_filters)
