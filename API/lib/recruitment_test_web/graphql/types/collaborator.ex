defmodule RecruitmentTestWeb.Graphql.Types.Collaborator do
  ...
  @desc "Paginated collaborators result"
  object :paginated_collaborators do
    field(:data, non_null(list_of(non_null(:collaborator))))
  ...
  input_object :collaborator_filters do
    field(:name, :string)
    field(:email, :string)
